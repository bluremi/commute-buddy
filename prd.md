...
│           ├── res/
│           │   ├── layout/activity_main.xml        # Configure Commute button + direction toggle (MaterialButtonToggleGroup) + Fetch Live button + AI POC section
