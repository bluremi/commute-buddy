...
object SystemPromptBuilder {
    ...
    fun buildSystemPrompt(profile: CommuteProfile): String {
        ...
        return buildString {
            ...
            append("- NORMAL: No alerts significantly affect any primary leg for the current direction, or alerts are resolved/irrelevant. Alerts that affect only alternate lines (not primary legs) do NOT change a NORMAL determination.\n")
            ...
            append("- ONLY evaluate alternate lines if at least one primary leg for the current direction is significantly disrupted. If the primary legs are clear, return NORMAL — do not factor alternate line alerts into the decision.\n")
